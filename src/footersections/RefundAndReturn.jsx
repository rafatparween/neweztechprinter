const returnRefundPolicyContent = [
  {
    sectionTitle: 'Thank you for shopping at EzTech-Printer-Solutions ',
    content: [
    ...
    subSections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to EzTech-Printer-Solutions.',
