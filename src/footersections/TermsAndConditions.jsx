...
const termsAndConditionsContent = [
  {
    ...
    content: [
      'These terms and conditions outline the rules and regulations for the use of EzTech-Printer-Solutions ’ Website, located at https://eztechprintersolutions.com/.',
